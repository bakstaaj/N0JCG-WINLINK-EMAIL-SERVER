...
def footer(canvas, doc):
    ...
    canvas.drawString(0.78 * inch, 0.36 * inch, "N0JCG Open Radio Platform  |  N0JCG Winlink Email Server v0.1.4")
...
def build():
    ...
    screenshot_specs = [
        ...
        (ROOT / "docs" / "assets" / "webmail-signin-v0.1.4.png", "Current Winlink webmail sign-in surface."),
