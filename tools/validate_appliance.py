...
def main() -> int:
    ...
    required_files = (
        ...
        ROOT / "deploy/setup_connectivity.sh",
        ROOT / "deploy/n0jcg-usb-gadget.sh",
        ROOT / "deploy/n0jcg-usb-gadget.service",
        ROOT / "deploy/n0jcg-network-fallback.sh",
        ROOT / "deploy/n0jcg-network-fallback.service",
